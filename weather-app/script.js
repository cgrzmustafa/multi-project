...
function onSuccess(position) {
  ...
  api = `https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&units=metric&appid=d2b71855ab17e93c412c31a2e6cd46d5`;
  fetchData();
}
...
function requestApi(city) {
  api = `https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&appid=d2b71855ab17e93c412c31a2e6cd46d5`;
  fetchData();
}
